...
- If one doesn't exist, [open a new
  issue](https://github.com/mas-cli/mas/issues/new/choose)
...
- [Fork the repository](https://github.com/mas-cli/mas#fork-button) on GitHub
...
- Releases (including release notes) are published on the [Releases
  page](https://github.com/mas-cli/mas/releases)

## Becoming a Contributor

To join the [team](https://github.com/orgs/mas-cli/teams/contributors), once a
few of your PRs have been accepted, [open an
issue](https://github.com/mas-cli/mas/issues/new) titled "Add Contributor:
@YourGitHubUsername".
