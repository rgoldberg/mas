...
complete -c mas -n '__fish_seen_subcommand_from outdated update upgrade; and not __fish_contains_opt accurate; and not __fish_contains_opt inaccurate' -l accurate -d 'Accurate, slower outdated app detection'
complete -c mas -n '__fish_seen_subcommand_from outdated update upgrade; and not __fish_contains_opt accurate; and not __fish_contains_opt inaccurate' -l inaccurate -d 'Inaccurate, faster outdated app detection'
