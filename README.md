...
| [NixOS](https://nixos.org) [`nixpkgs`](http://search.nixos.org/packages)      | `nix-shell -p mas`                        | [![MacPorts](https://repology.org/badge/version-for-repo/nix_unstable/mas-mac-app-store.svg?header=)](https://search.nixos.org/packages?channel=unstable&query=mas#show=mas)                                                                | 13+               |
