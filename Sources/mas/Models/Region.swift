...
private extension Region {
	var appStoreRegion: Self { // swiftlint:disable switch_case_on_newline
		...
		case "BQ": "NL" // Bonaire, Sint Eustatius & Saba             > Netherlands
		...
		case "GS": "GB" // South Georgia & the South Sandwich Islands > United Kingdom
		case "GU": "US" // Guam                                       > United States
		case "HM": "AU" // Heard Island & McDonald Islands            > Australia
		...
		case "PM": "FR" // St. Pierre & Miquelon                      > France
		...
		case "SH": "GB" // St. Helena, Ascension & Tristan da Cunha   > United Kingdom
		case "SJ": "NO" // Svalbard & Jan Mayen                       > Norway
		...
		case "WF": "FR" // Wallis & Futuna                            > France
