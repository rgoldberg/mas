...
extension MAS {
	...
	struct Install: AsyncParsableCommand, EffectiveDropping {
		...
		func run() async throws {
			try await AppStore.install.apps(withAppIDs: catalogAppsOptionGroup.appIDs, force: forceOptionGroup.force)
		}
	}
}
